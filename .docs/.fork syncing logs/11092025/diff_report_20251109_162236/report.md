...
## Added Files (90) - New Files that Kortix/Suna has but Logrui/Suna does not have yet - SAFE - (keep theirs) - add all from Main
...
## Modified Files (225) - either modified by Kortix Team or modified by us for Logrui/Suna - will need a second diff to know for sure - need to identify which are modified by us. The ones untouched by us as new updates from the Kortix Suna Team

- .gitignore (keep ours)
- backend/.env.example (needs manual review)
- backend/.gitignore (needs manual review)
- backend/api.py (keep theirs)
- backend/core/agent_loader.py (needs manual review)
- backend/core/agent_runs.py (needs manual review)
- backend/core/agent_service.py (needs manual review)
- backend/core/agent_tools.py (needs manual review)
- backend/core/agentpress/error_processor.py (needs manual review)
- backend/core/agentpress/response_processor.py (needs manual review)
- backend/core/agentpress/thread_manager.py 
- backend/core/agentpress/xml_tool_parser.py
- backend/core/ai_models/ai_models.py (needs manual review)
- backend/core/ai_models/manager.py (needs manual review)
- backend/core/ai_models/registry.py (needs manual review)
- backend/core/api.py (needs manual review)
- backend/core/billing/api.py (keep theirs)
- backend/core/billing/billing_integration.py (keep theirs)
- backend/core/billing/config.py (keep theirs)
- backend/core/billing/payment_service.py (keep theirs)
- backend/core/billing/subscription_service.py (keep theirs)
- backend/core/billing/trial_service.py (keep theirs)
- backend/core/billing/webhook_service.py (keep theirs)
- backend/core/composio_integration/api.py (keep theirs)
- backend/core/composio_integration/composio_profile_service.py (keep theirs)
- backend/core/credits.py (keep theirs)
- backend/core/knowledge_base/api.py (keep theirs)
- backend/core/knowledge_base/file_processor.py (keep theirs)
- backend/core/prompts/prompt.py (keep theirs)
- backend/core/run.py (keep theirs)
- backend/core/sandbox/docker/docker-compose.yml (keep theirs)
- backend/core/sandbox/sandbox.py (keep theirs)
- backend/core/services/llm.py (keep theirs)
- backend/core/templates/utils.py (keep theirs)
...
- frontend/src/app/(dashboard)/agents/config/[agentId]/page.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/config/[agentId]/screens/instructions-screen.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/config/[agentId]/screens/integrations-screen.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/config/[agentId]/screens/knowledge-screen.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/config/[agentId]/screens/tools-screen.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/config/[agentId]/screens/triggers-screen.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/config/[agentId]/screens/workflows-screen.tsx (keep theirs)
- frontend/src/app/(dashboard)/agents/page.tsx (keep theirs)
- frontend/src/app/(dashboard)/model-pricing/page.tsx (keep theirs)
- frontend/src/app/(dashboard)/onboarding-demo/page.tsx (keep theirs)
- frontend/src/app/(dashboard)/settings/api-keys/page.tsx (keep theirs)
- frontend/src/app/(home)/layout.tsx (keep theirs)
- frontend/src/app/(home)/page.tsx (keep theirs)
- frontend/src/app/activate-trial/page.tsx (keep theirs)
- frontend/src/app/auth/actions.ts (keep theirs)
- frontend/src/app/auth/callback/route.ts (keep theirs)
- frontend/src/app/auth/page.tsx (keep theirs)
- frontend/src/app/layout.tsx (keep theirs)
- frontend/src/app/legal/page.tsx (keep theirs)
- frontend/src/app/metadata.ts (keep theirs)
- frontend/src/app/not-found.tsx (keep theirs)
- frontend/src/app/share/[threadId]/_components/ShareThreadLayout.tsx (keep theirs)
- frontend/src/app/share/[threadId]/_hooks/useShareThreadData.ts (keep theirs)
- frontend/src/app/share/[threadId]/layout.tsx (keep theirs)
- frontend/src/app/share/[threadId]/page.tsx (keep theirs)
- frontend/src/app/subscription/page.tsx (keep theirs)
- frontend/src/components/admin/admin-user-details-dialog.tsx (keep theirs)
- frontend/src/components/admin/admin-user-table.tsx (keep theirs)
- frontend/src/components/agents/agent-configuration-dialog.tsx (keep theirs)
- frontend/src/components/agents/agent-count-limit-dialog.tsx (keep theirs)
- frontend/src/components/agents/agent-creation-modal.tsx (keep theirs)
- frontend/src/components/agents/agent-selector.tsx (keep theirs)
- frontend/src/components/agents/agents-grid.tsx (keep theirs)
...
- frontend/src/components/agents/custom-agents-page/tabs-navigation.tsx (keep ours)
...
## Deleted Files (215) OR they dont exist in upstream/Main because we added them in our custom fork

- .claude/settings.local.json (keep ours)
- ALL_MIGRATIONS.sql (keep ours)
- backend/core/agentpress/continue.py (keep ours)
- backend/core/ai_models/ollama_client.py (keep ours)
...
- files-to-protect.txt (keep ours)
