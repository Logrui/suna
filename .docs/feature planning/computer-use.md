replicate Manus AI's virtual machine platform 

Identify best potential models for computer use or browser use

Create a tool call that enables the primary agent to delegate computer related tasks to computer use models/agents

Update tool-view-panel
