...
CORE_TOOLS = [
    ...
    ('project_memory_tool', 'core.tools.project_memory_tool', 'ProjectMemoryTool'),
...
SANDBOX_TOOLS = [
    ...
    ('sb_git_sync', 'core.tools.sb_git_sync', 'SandboxGitTool'),
    ('sb_ssh_tool', 'core.tools.sb_ssh_tool', 'SandboxSSHTool'),
]
...
SEARCH_TOOLS = [
    ...
    ('perplexity_search_tool', 'core.tools.perplexity_search_tool', 'PerplexitySearchTool'),
