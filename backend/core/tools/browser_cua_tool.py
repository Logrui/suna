# feature: add Computer Use Agent Browser Tool using Stagehand CUA API for more complex browser automation
...
@tool_metadata(
    display_name="Computer Use Agent Browser",
    description="Utilize a Computer Use Subagent to browse websites, click buttons, fill forms, and extract information from web pages",
    icon="Globe",
    color="bg-cyan-100 dark:bg-cyan-800/50",
    weight=60,
    visible=True
)
class ComputerUseAgentBrowserTool(SandboxToolsBase):
    """
    Computer Use Agent Browser Tool for browser automation using local Stagehand API.
