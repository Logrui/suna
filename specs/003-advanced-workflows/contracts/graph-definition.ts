/**
 * TypeScript Schema: Graph Definition (Visual State)
 *
 * This file defines the TypeScript interfaces for the graph_definition JSONB field
 * stored in agent_workflows table. This represents the VISUAL state of the workflow
 * as displayed in React Flow canvas.
 *
