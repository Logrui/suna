...
1. **Never Create Docs in Repo Root**  
   - All new documentation files MUST live under `.docs/` or a clearly
     associated documentation directory such as a temporary directory.
   - The repo root is reserved for project‑wide meta files (e.g. `README.md`,
     `CLAUDE.md`, `GEMINI.md`, `LICENSE`).
...
2. **Top‑Level Documentation Folders**  
   ...
   - `.docs/addon-features`
   - `.docs/bugfixes/17. console logs cleanup part 2`
   - `.docs/bugfixes/7. sandbox debugging`
   - `.docs/architecture`
   - `.docs/native-architecture` for research on existing architecture
   - `.docs/`
