---
trigger: glob
globs: "backend/core/tools/**/*.py",  "frontend/src/components/thread/tool-views/**/*.tsx", "apps/mobile/components/chat/tool-views/**/*.tsx"
---
...
- UV is faster and provides better depende
