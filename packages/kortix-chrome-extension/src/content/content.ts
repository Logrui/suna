...
chrome.runtime.onMessage.addListener(
  (request: CommandRequest, sender, sendResponse) => {
 ...
 */
async function handleScreenshot(params: any): Promise<any> {
  try {
 ...
 */
async function handleExtractEmails(params: any): Promise<any> {
 ...
 */
async function handleGetElements(params: any): Promise<any> {
 ...
 */
async function handleGetPageInfo(params: any): Promise<any> {
  return {
    title: document.title,
    url: window.location.href,
