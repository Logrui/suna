...
import type { GraphDefinition, CompiledLogic } from '@/components/workflows/types';
interface Workflow {
  id: string;
  account_id: string;
  agent_id: string;
...
//USED BY THE OLD ADVANCED WORKFLOW EDITOR, KEPT EXTRA FUNCTIONS FOR BACKWARD COMPATIBILITY
