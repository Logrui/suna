      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-lg [&>button]:hidden">
          <DialogHeader>
            ...
            <DialogDescription>
              Select a browser for your Kortix Worker
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Install the Kortix Browser Operator extension to enable
                      workers to access your personal context
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-xs text-muted-foreground">
                        Cloud-hosted browser without personal context
                      </span>
                    </div>
                  </div>
                </button>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will remove the browser from your account. You can reconnect
              it later by installing the extension again.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
