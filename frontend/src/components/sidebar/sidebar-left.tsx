...
import { Users, Menu, Plus, Zap, MessageCircle, PanelLeftOpen, PanelLeftClose, Search, Bell, Folder, Database, Workflow, ChevronRight, BookOpen, Code, Star, Package, Sparkle, Sparkles, X, Settings, LogOut, User, CreditCard, Key, Plug, Shield, DollarSign, KeyRound, Sun, Moon, Book, PanelsTopLeft } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          {state === 'collapsed' ? (
            ...
            >
              ...
              <div className="w-full flex flex-col items-center space-y-3">
                {[
                  { view: 'chats' as const, icon: PanelsTopLeft, label: 'Projects' },
            ...
            >
              <div className="px-6 pt-4 space-y-4">
                ...
                <div className="flex justify-between items-center gap-2">
                  {[
                    { view: 'chats' as const, icon: MessageCircle, label: 'Projects' },
                    { view: 'agents' as const, icon: Users, label: 'Workers' },
                    { view: 'triggers' as const, icon: Zap, label: 'Triggers' }
                  ].map(({ view, icon: Icon, label }) => (
                    <Link
