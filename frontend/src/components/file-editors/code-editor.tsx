...
const langsTyped = langs as Record<string, () => any>;
const languageMap: Record<string, () => any> = {
  js: () => langsTyped.javascript(),
  javascript: () => langsTyped.javascript(),
  jsx: () => langsTyped.jsx(),
  ts: () => langsTyped.typescript(),
  typescript: () => langsTyped.typescript(),
  tsx: () => langsTyped.tsx(),
  html: () => langsTyped.html(),
  css: () => langsTyped.css(),
  json: () => langsTyped.json(),
  md: () => langsTyped.markdown(),
  markdown: () => langsTyped.markdown(),
  python: () => langsTyped.python(),
  py: () => langsTyped.python(),
  rust: () => langsTyped.rust(),
  go: () => langsTyped.go(),
  java: () => langsTyped.java(),
  c: () => langsTyped.c(),
  cpp: () => langsTyped.cpp(),
  cs: () => langsTyped.csharp(),
  csharp: () => langsTyped.csharp(),
  php: () => langsTyped.php(),
  ruby: () => langsTyped.ruby(),
  rb: () => langsTyped.ruby(),
  sh: () => langsTyped.shell(),
  bash: () => langsTyped.shell(),
  shell: () => langsTyped.shell(),
  sql: () => langsTyped.sql(),
  yaml: () => langsTyped.yaml(),
  yml: () => langsTyped.yaml(),
  xml: () => langsTyped.xml(),
  swift: () => langsTyped.swift(),
  kotlin: () => langsTyped.kotlin(),
  scala: () => langsTyped.scala(),
  r: () => langsTyped.r(),
  lua: () => langsTyped.lua(),
  perl: () => langsTyped.perl(),
  toml: () => langsTyped.toml(),
};
