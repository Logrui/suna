...
const MOCK_TEAMS = [
  {
    ...
    description: 'A dedicated team for deep web research, data analysis, and report generation.',
    agents: [
      { id: 'a1', name: 'DeepSeeker', role: 'Researcher', icon_name: 'Search', icon_color: '#3b82f6', icon_background: '#eff6ff' },
      { id: 'a2', name: 'Analyst Pro', role: 'Data Analyst', icon_name: 'BarChart', icon_color: '#10b981', icon_background: '#ecfdf5' },
      { id: 'a3', name: 'Writer Bot', role: 'Technical Writer', icon_name: 'PenTool', icon_color: '#8b5cf6', icon_background: '#f5f3ff' },
    ],
  ...
  },
  {
    ...
    agents: [
      { id: 'a4', name: 'IdeaGen', role: 'Creative Director', icon_name: 'Lightbulb', icon_color: '#f59e0b', icon_background: '#fffbeb' },
      { id: 'a5', name: 'CopyMaster', role: 'Copywriter', icon_name: 'Type', icon_color: '#ec4899', icon_background: '#fdf2f8' },
    ],
