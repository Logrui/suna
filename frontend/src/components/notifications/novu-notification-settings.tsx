...
import { notificationAPI, type NotificationSettings } from '@/lib/api/novu-notifications';
...
export function NotificationSettingsPanel() {
    ...
    useEffect(() => {
        // Removed isStagingMode check for visual testing
        loadSettings();
    }, []);
    ...
    const loadSettings = async () => {
        try {
            ...
            // toast.error('Failed to load notification settings'); // Suppress for now as backend is not ready
            setLoading(false);
        } finally {
            setLoading(false);
        }
